...
public class ForumController {
  ...
  public String postDetail(@PathVariable int id, Model model) throws ResourceNotFoundException {
      ...
      model.addAttribute("commentList", commentList); // Add the commentList attribute
  ...
  public String getCommentForm(@PathVariable int id, Model model) throws ResourceNotFoundException {
      Optional<Post> post = postRepository.findById(id);
      if (post.isEmpty()) {
          throw new ResourceNotFoundException("No post with the requested ID");
      }
